...
import { IoLogoGoogle, IoLogoGithub,IoLogoTwitter } from 'react-icons/io';
...
const SignIn = ({ onGithubSignIn, onGoogleSignIn, onTwitterSignIn , loading }) => {
      ...
      {loading ? (
        ...
        <>
          ...
          <Button
            variant="contained"
            color="secondary"
            className={[classes.button, classes.twitterButton]}
            onClick={onTwitterSignIn}
            disabled={loading}
          >
            <div className={classes.iconContainer}>
              <IoLogoTwitter fill="#fff" width="24" height="24" />
              &nbsp;
